...
const FeatureList = [
  ...
  },
  {
    ...
    description: (
      <>
        Join the X-Team and profit by the inspring motivation to discover and build new things. Hop on the <a href="https://discord.iota.org?ref=xteampage">IOTA Discord</a> and become a part of a X-Team using <a href="https://github.com/iota-community/IOTA-eXperience-Team/issues/new?assignees=antonionardella&labels=application&template=x-team-initiative-application.md&title=%5BApplication%5D">this appliction</a>.
      </>
    ),
  },
];
